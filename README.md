...
<img width="400" src="./readme_source/天氣資訊推播專案_聊天畫面.gif">
...
## Updates
### version two
- [x] Add a Jupyter Notebook to run Streamlit App on a temporary Url generated by Ngrok
- [x] Add LLM response in  `./QAflow/retrieve_data.py` with `gemma 2b`
- [x] Update Embedding model to `jinaai/jina-embeddings-v2-base-zh` in `.env` file according to the article [使用繁體中文評測各家 Embedding 模型的檢索能力](https://ihower.tw/blog/archives/12167) 
